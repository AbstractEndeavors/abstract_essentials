...
from abstract_utilities.string_clean import eatAll,safe_split
...
def get_env_value(start_path:str=None,file_name:str=DEFAULT_FILE_NAME, key:str=DEFAULT_KEY):
    """
