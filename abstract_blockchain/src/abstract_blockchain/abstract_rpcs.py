...
def get_rpc_layout(RPC_list:list=get_default_rpc_list(),window_mgr:type(window_mgr)=window_mgr):
...
def Choose_RPC_Parameters_GUI(RPC_list:list=get_default_rpc_list()) -> dict or None:
