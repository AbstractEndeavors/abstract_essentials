...
print(home)
fname = varis['name']+'.txt'
stats = reader('num_track.txt')
whole = reader(fname)
...
while int(i) < int(300):
    if str(i) in stats:
        new = stats[str(i)]
        new = new['adds']
        if '0x2d20d26c9f9208ae0be0e51426da339309995f35' in new:
            print('you in it nigga',i)
            var_len = len('0x2d20d26c9f9208ae0be0e51426da339309995f35')
            print(var_len)
            bef = len(str(whole))
            rev = str(whole).replace('0x2d20d26c9f9208ae0be0e51426da339309995f35','')
            aft = len(str(rev))
            print(aft)
            fin_len = bef - aft
            print(bef,'-',aft,'=',fin_len)
            print(fin_len)
            quant = float(fin_len)/float(var_len)
            print(quant)
